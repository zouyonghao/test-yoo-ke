...
;(function(factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(['src/main/webapp/static/js/jquery'], factory);
    } else if (typeof exports !== 'undefined') {
        module.exports = factory(require('src/main/webapp/static/js/jquery'));
    } else {
        factory(jQuery);
    }
